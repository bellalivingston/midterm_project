...
team_eff_small <-
  readRDS(
    here::here("output/objects", "team_eff_small.rds"))
...
player_eff <-
  readRDS(
    here::here("output/objects", "player_eff.rds")
  )


knitr::include_graphics(here::here("output/figures", "top_players_eff.png"))
```
...
impact_rank<-
  readRDS(
    here::here("output/objects", "impact_rank.rds")
  )
  
knitr::include_graphics(here::here("output/figures", "top_players_impact.png"))
